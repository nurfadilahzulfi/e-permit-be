...
@section('title', 'Manajemen Master HWP - E-Permit')
@section('page-title', 'Manajemen Master HWP')
...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 border-b pb-4 dark:border-slate-700">
    <h2 class="text-2xl font-extrabold text-slate-800 dark:text-slate-100 mb-3 sm:mb-0">
        Master Checklist HWP (Kerja Panas)
    </h2>
    <button id="addBtn"
...
<div id="itemModal"
    ...
    <div id="modalBox"
        ...
        <div class="flex-shrink-0 px-6 py-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-white dark:bg-slate-900 z-10 rounded-t-2xl">
            <h3 id="modalTitle" class="text-xl font-bold text-slate-800 dark:text-slate-100">Tambah Checklist HWP</h3>
            ...
            <form id="itemForm">
                ...
                <div>
                    ...
                    <input id="nama" name="nama" type="text" required
                           class="w-full mt-1 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-sm dark:bg-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Area kerja bebas bahan mudah terbakar">
                </div>
...
<script>
// =================================================================
// SCRIPT INI DI-SET UNTUK 'hwp-cek-ls'
// =================================================================
document.addEventListener('DOMContentLoaded', () => {
    
    // --- Variabel & Referensi [PERUBAHAN] ---
    const R_INDEX = '{{ route("hwp-cek-ls.index") }}';
    const R_STORE = '{{ route("hwp-cek-ls.store") }}';
    const R_PREFIX = 'hwp-cek-ls'; // prefix for update/delete/show
    ...
    function openAddModal() {
        ...
        document.getElementById('modalTitle').innerText = 'Tambah Checklist HWP Baru';
        showModal();
    }
    ...
    window.editItem = async (id) => {
        try {
            ...
            document.getElementById('modalTitle').innerText = 'Edit Checklist HWP';
            showModal();
        } catch (e) {
