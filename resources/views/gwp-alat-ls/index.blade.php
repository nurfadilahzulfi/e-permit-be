...
@section('title', 'Manajemen Master Alat - E-Permit')
@section('page-title', 'Manajemen Master Alat')
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
            <thead class="bg-slate-50 dark:bg-slate-700">
                <tr>
                    <th class="py-3 px-4 text-left text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Nama Alat / APD</th>
...
<div id="itemModal"
    ...
    <div id="modalBox"
        ...
        <div class="flex-shrink-0 px-6 py-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-white dark:bg-slate-900 z-10 rounded-t-2xl">
            <h3 id="modalTitle" class="text-xl font-bold text-slate-800 dark:text-slate-100">Tambah Alat</h3>
        ...
        <div class="px-6 py-4 overflow-y-auto flex-1">
            <form id="itemForm">
                ...
                <div>
                    <label class="text-slate-700 dark:text-slate-200 text-sm font-medium">Nama Alat / APD</label>
                    <input id="nama" name="nama" type="text" required
                           class="w-full mt-1 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-sm dark:bg-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Helm Safety">
                </div>
...
<script>
// =================================================================
// SCRIPT INI DI-SET UNTUK 'gwp-alat-ls'
// =================================================================
document.addEventListener('DOMContentLoaded', () => {
    
    // --- Variabel & Referensi ---
    const R_INDEX = '{{ route("gwp-alat-ls.index") }}';
    const R_STORE = '{{ route("gwp-alat-ls.store") }}';
    const R_PREFIX = 'gwp-alat-ls'; // prefix for update/delete/show
    ...
    function openAddModal() {
        ...
        document.getElementById('modalTitle').innerText = 'Tambah Alat Baru';
        showModal();
    }
    ...
    window.editItem = async (id) => {
        try {
            ...
            document.getElementById('modalTitle').innerText = 'Edit Alat';
            showModal();
        } catch (e) {
