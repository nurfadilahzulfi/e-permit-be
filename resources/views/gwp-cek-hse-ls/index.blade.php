...
@section('title', 'Manajemen Checklist HSE - E-Permit')
@section('page-title', 'Manajemen Checklist HSE')
            ...
            <form id="itemForm">
                ...
                <div>
                    ...
                    <input id="nama" name="nama" type="text" required
                           class="w-full mt-1 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-sm dark:bg-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Verifikasi kesesuaian JSA">
                </div>
...
<script>
// =================================================================
// SCRIPT INI DI-SET UNTUK 'gwp-cek-hse-ls'
// =================================================================
document.addEventListener('DOMContentLoaded', () => {
    
    // --- Variabel & Referensi ---
    const R_INDEX = '{{ route("gwp-cek-hse-ls.index") }}';
    const R_STORE = '{{ route("gwp-cek-hse-ls.store") }}';
    const R_PREFIX = 'gwp-cek-hse-ls'; // prefix for update/delete/show
